...
<html lang="en">
  <head>
    ...
    <title>Service Provider Catalog - FileSystem OSLC Adapter</title>
  ...
  <div class="container">
    <div class="page-header">
      <h1>FileSystem Service Provider Catalogue</h1>
    </div>
    ...
    <% if (catalog.getServiceProviders().length == 0) {%>
        <div class="alert alert-primary" role="alert">
            ...
            <p>
                ...
                in the class <code>com.krusty84.fileconnector.RestDelegate</code>, to return the expected set of Service Provider resources.
            </p>
        </div>
    <% } %>
