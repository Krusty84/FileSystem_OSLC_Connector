...
package com.krusty84.fileconnector.auth;
...
public class AuthenticationApplication implements Application {
    ...
    public final static String APPLICATION_NAME = "FS_OAuth";
    public final static String OAUTH_REALM = "FS_OAuth";
    protected final static String APPLICATION_CONNECTOR_SESSION_ATTRIBUTE = "com.krusty84.fileconnector.auth.ApplicationConnector";
    protected final static String APPLICATION_CONNECTOR_ADMIN_SESSION_ATTRIBUTE = "com.krusty84.fileconnector.auth.AdminSession";
