...
public class ServiceProviderCatalogService
{
    ...
    public void getHtmlServiceProvider(@PathParam("someId") final String someId)
    {
        ...
        it needs for hold selected providerCatalog for some reasons in the future*/
        GlobalConstantsVariables.currentServiceProviderCatalog=catalog.getTitle();
        //for debug reason
        System.out.println("The service provider catalog: "+catalog.getTitle()+" was called");
        if (catalog !=null )
        {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/krusty84/fileconnector/serviceprovidercatalog.jsp");
            try {
