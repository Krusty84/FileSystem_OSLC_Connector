...
public class ServiceProviderService
{
    ...
    public void getHtmlServiceProvider(@PathParam("serviceProviderId") final String serviceProviderId) throws ServletException, IOException
    {
        ...
        it needs for hold selected serviceProvider for some reasons in the future*/
        GlobalConstantsVariables.currentServiceProvider=serviceProvider.getTitle();
        //for debug reason
        System.out.println("The service provider: "+serviceProvider.getTitle()+" was called"+"_from: "+GlobalConstantsVariables.currentServiceProviderCatalog+" catalog");
        
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/krusty84/fileconnector/serviceprovider.jsp");
