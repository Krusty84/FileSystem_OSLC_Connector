...
// End of user code
@Path("files")
public class WebService_FileExposure
{
    ...
    @Operation(
        summary = "GET for resources of type {'" + Oslc_fsnspDomainConstants.FILE_LOCALNAME + "'}",
        description = "GET for resources of type {'" + "<a href=\"" + Oslc_fsnspDomainConstants.FILE_TYPE + "\">" + Oslc_fsnspDomainConstants.FILE_LOCALNAME + "</a>" + "'}" +
    ...
    public File getFile(
                @PathParam("file_id") final String file_id
        ) throws IOException, ServletException, URISyntaxException
    {
        // Start of user code getResource_init
        // End of user code

        final File aFile = delegate.getFile(httpServletRequest, file_id);

        if (aFile != null) {
            // Start of user code getFile
            // End of user code
            httpServletResponse.setHeader("ETag", delegate.getETagFromFile(aFile));
    ...
    public void getFileAsHtml(
        @PathParam("file_id") final String file_id
        ) throws ServletException, IOException, URISyntaxException
    {
        // Start of user code getFileAsHtml_init
        // End of user code
    	...
    	*/
        ...
        if (aFile != null) {
            ...
            RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/krusty84/fileconnector/viewresource.jsp");
        ...
        ) throws ServletException, IOException, URISyntaxException
    {
        ...
        // Start of user code getFileCompact_init
        ...
        if (aFile != null) {
            ...
            smallPreview.setDocument(UriBuilder.fromUri(aFile.getAbout()).path("smallPreview").build());
    ...
    @GET
    @Path("{file_id}/smallPreview")
    @Produces({ MediaType.TEXT_HTML })
    public void getFileAsHtmlSmallPreview(
        @PathParam("file_id") final String file_id
        ) throws ServletException, IOException, URISyntaxException
    {
        // Start of user code getFileAsHtmlSmallPreview_init
        // End of user code
        ...
        if (aFile != null) {
            httpServletRequest.setAttribute("aFile", aFile);
            // Start of user code getFileAsHtmlSmallPreview_setAttributes
            // End of user code
    ...
    @GET
    @Path("{file_id}/largePreview")
    @Produces({ MediaType.TEXT_HTML })
    public void getFileAsHtmlLargePreview(
        @PathParam("file_id") final String file_id
        ) throws ServletException, IOException, URISyntaxException
    {
        // Start of user code getFileAsHtmlLargePreview_init
        // End of user code
        ...
        if (aFile != null) {
            httpServletRequest.setAttribute("aFile", aFile);
            // Start of user code getFileAsHtmlLargePreview_setAttributes
            // End of user code
