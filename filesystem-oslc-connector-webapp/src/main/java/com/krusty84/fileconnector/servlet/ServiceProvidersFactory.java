...
public class ServiceProvidersFactory
{
    ...
    public static ServiceProvider createServiceProvider(final ServiceProviderInfo serviceProviderInfo) 
        ...
        String description = String.format("%s (id: %s; kind: %s)",
            " is a container of resources that is hosted by a tool or product",
            identifier,
            "Service Provider");
        ...
        final PrefixDefinition[] prefixDefinitions =
        {
            ...
            new PrefixDefinition(Oslc_fsnspDomainConstants.FILE_SYSTEM_NAMSPACE_PREFIX, new URI(Oslc_fsnspDomainConstants.FILE_SYSTEM_NAMSPACE))
        };
