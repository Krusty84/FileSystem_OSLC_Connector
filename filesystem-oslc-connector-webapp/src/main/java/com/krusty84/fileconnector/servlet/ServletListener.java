...
public class ServletListener implements ServletContextListener  {
    ...
    public void contextInitialized(final ServletContextEvent servletContextEvent)
    {
        ...
        //*krusty84, was changed port after generate boilerplate code, the value must be aligned with oslc model project (configuration block)
        String fallbackBase = "http://localhost:8181";
